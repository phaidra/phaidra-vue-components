...
const vocabularies = {
  ...
  'rolepredicate': {
    terms: [
      ...
      { '@id': 'role:aut', 'skos:prefLabel': { 'eng': 'Author', 'deu': 'Autor*in', 'ita': 'Author' }, 'skos:definition': {  'eng': 'A person, family, or organization responsible for creating a work that is primarily textual in content, regardless of media type (e.g., printed text, spoken word, electronic text, tactile text) or genre (e.g., poems, novels, screenplays, blogs). Use also for persons, etc., creating a new work by paraphrasing, rewriting, or adapting works by another creator such that the modification has substantially changed the nature and content of the original or changed the medium of expression.',  'deu': '...' } },
      ...
      { '@id': 'role:ctr', 'skos:prefLabel': { 'eng': 'Contractor', 'deu': 'Vertragspartner*in', 'ita': 'Contractor' }, 'skos:definition': {  'eng': 'A person or organization relevant to a resource, who enters into a contract with another person or organization to perform a specific task.',  'deu': '...' } },
