...
const vocabularies = {
  ...
  'datepredicate': {
    terms: [
      { '@id': 'dcterms:date', 'skos:prefLabel': { 'eng': 'Date', 'deu': 'Datum', 'ita': 'Data' } },
      { '@id': 'dcterms:created', 'skos:prefLabel': { 'eng': 'Date created', 'deu': 'Erstellungsdatum', 'ita': 'Data di creazione' } },
      { '@id': 'dcterms:modified', 'skos:prefLabel': { 'eng': 'Date modified', 'deu': 'Änderungsdatum', 'ita': 'Data di modifica' } },
      { '@id': 'dcterms:available', 'skos:prefLabel': { 'eng': 'Date available', 'deu': 'Verfügbarkeitsdatum', 'ita': 'Data di disponibilità' } },
      { '@id': 'dcterms:issued', 'skos:prefLabel': { 'eng': 'Date issued', 'deu': 'Erscheinungsdatum', 'ita': 'Data di rilascio' } },
      { '@id': 'dcterms:valid', 'skos:prefLabel': { 'eng': 'Date valid', 'deu': 'Gültigkeitsdatum', 'ita': 'Data di validità' } },
      { '@id': 'dcterms:dateAccepted', 'skos:prefLabel': { 'eng': 'Date accepted', 'deu': 'Annahmedatum', 'ita': 'Data di accettazione' } },
      { '@id': 'dcterms:dateCopyrighted', 'skos:prefLabel': { 'eng': 'Date copyrighted', 'deu': 'Copyright Datum', 'ita': 'Data di copyright' } },
      { '@id': 'dcterms:dateSubmitted', 'skos:prefLabel': { 'eng': 'Date submitted', 'deu': 'Datum der Einreichung', 'ita': 'Data di presentazione' } },
      { '@id': 'rdau:P60071', 'skos:prefLabel': { 'eng': 'Date of production', 'deu': 'Produktionsdatum', 'ita': 'Data di produzione' } },
      { '@id': 'phaidra:dateAccessioned', 'skos:prefLabel': { 'eng': 'Date accessioned', 'deu': 'Eingangsdatum', 'ita': 'Data di registrazione' } },
      { '@id': 'dcterms:temporal', 'skos:prefLabel': { 'eng': 'Temporal coverage', 'deu': 'Zeitliche Abdeckung', 'ita': 'Copertura temporale' } },
      { '@id': 'phaidra:dateApprobation', 'skos:prefLabel': { 'eng': 'Approbation date', 'deu': 'Approbationsdatum', 'ita': 'Data di approvazione' } }
    ],
    loaded: true
  },
  'placetype': {
    terms: [
      { '@id': 'schema:Place', 'skos:prefLabel': { 'eng': 'Place', 'deu': 'Ort', 'ita': 'Luogo' } },
      { '@id': 'schema:AdministrativeArea', 'skos:prefLabel': { 'eng': 'AdministrativeArea', 'deu': 'Verwaltungseinheit', 'ita': 'Area amministrativa' } }
    ],
    loaded: true
  },
  'identifiertype': {
    terms: [
      ...
      { '@id': 'phaidra:acnumber', 'skos:prefLabel': { 'eng': 'AC number', 'deu': 'AC Nummer', 'ita': 'AC Number (Austrian Central Catalogue Number)' }, 'skos:example': 'AC13399179' }
    ],
    loaded: true
  },
  ...
  'citationpredicate': {
    terms: [
      ...
      { '@id': 'cito:citesAsDataSource', 'skos:prefLabel': { 'eng': 'Cites as data source', 'deu': 'Verweist auf Dataset', 'ita': 'Cita come fonte' } },
      { '@id': 'cito:isCitedBy', 'skos:prefLabel': { 'eng': 'Is cited by', 'deu': 'Zitiert von', 'ita': 'È citato da' } }
    ],
    loaded: true
  },
  'rolepredicate': {
    terms: [
      { '@id': 'role:oth', 'skos:prefLabel': { 'eng': 'Other', 'deu': 'Andere', 'ita': 'Altro' }, 'skos:definition': { 'eng': 'A role that has no equivalent in the MARC list.', 'deu': 'Eine Rolle, die keine Entsprechung in der MARC-Liste hat.', 'ita': 'Un ruolo che non ha equivalenti nella lista MARC.' } },
      ...
      { '@id': 'role:advisor', 'skos:prefLabel': { 'eng': 'Advisor', 'deu': 'Betreuer*in der Hochschulschrift', 'ita': 'Supervisore' }, 'skos:definition': {'eng': 'A person under whose supervision a degree candidate develops and presents a university thesis.', 'deu': 'Eine Person, unter deren Aufsicht ein*e Kandidat*in eine Hochschulschrift erarbeitet und vorlegt.' } },
      ...
      { '@id': 'role:app', 'skos:prefLabel': { 'eng': 'Applicant', 'deu': 'Antragsteller*in', 'ita': 'Richiedente' }, 'skos:definition': {  'eng': 'A person or organization responsible for the submission of an application or who is named as eligible for the results of the processing of the application (e.g., bestowing of rights, reward, title, position).',  'deu': 'Eine Person oder Organisation, die für die Einreichung eines Antrags verantwortlich ist oder die für die Ergebnisse der Antragsbearbeitung (z. B. Verleihung von Rechten, Belohnung, Titel, Position) als berechtigt benannt wird.' } },
      ...
      { '@id': 'role:acp', 'skos:prefLabel': { 'eng': 'Art copyist', 'deu': 'Kunstkopist*in', 'ita': 'Copista d\'arte' }, 'skos:definition': {  'eng': 'A person (e.g., a painter or sculptor) who makes copies of works of visual art.',  'deu': 'Eine Person (z. B. ein*e Maler*in oder Bildhauer*in), die Kopien von Werken der bildenden Kunst anfertigt.' } },
      ...
      { '@id': 'role:assessor', 'skos:prefLabel': { 'eng': 'Assessor', 'deu': 'Beurteiler*in der Hochschulschrift', 'ita': 'Valutatore di tesi' }, 'skos:definition': { 'eng': 'A person who assesses a university thesis.', 'deu': 'Eine Person, die eine Hochschulschrift beurteilt.' } },
      { '@id': 'role:asg', 'skos:prefLabel': { 'eng': 'Assignee', 'deu': 'Rechtsnachfolger*in', 'ita': 'Assegnatario della licenza di pubblicazione' }, 'skos:definition': {  'eng': 'A person or organization to whom a license for printing or publishing has been transferred.',  'deu': 'Eine Person oder Organisation, der eine Lizenz für Druck oder Veröffentlichung übertragen wurde.' } },
      ...
      { '@id': 'role:ato', 'skos:prefLabel': { 'eng': 'Autographer', 'deu': 'Unterzeichnende/r', 'ita': 'Autografatore' }, 'skos:definition': { 'eng': 'A person whose manuscript signature appears on an item.',  'deu': 'Eine Person, deren handschriftliche Unterschrift auf einem Gegenstand erscheint.' } },
      ...
      { '@id': 'role:bdd', 'skos:prefLabel': { 'eng': 'Binding designer', 'deu': 'Buchbinde-Designer*in', 'ita': 'Designer della legatura' }, 'skos:definition': {  'eng': 'A person or organization responsible for the binding design of a book, including the type of binding, the type of materials used, and any decorative aspects of the binding.',  'deu': 'Eine Person oder Organisation, die für die Gestaltung des Einbands eines Buches verantwortlich ist, einschließlich der Art des Einbands, der verwendeten Materialien und aller dekorativen Aspekte des Einbands.' } },
      ...
      { '@id': 'role:bpd', 'skos:prefLabel': { 'eng': 'Bookplate designer', 'deu': 'Designer*in des Exlibris', 'ita': 'Designer dell\'ex-libris' }, 'skos:definition': {  'eng': 'A person or organization responsible for the design of a book owner\'s identification label that is most commonly pasted to the inside front cover of a book.',  'deu': 'Eine Person oder Organisation, die für die Gestaltung des Kennzeichnungsetiketts eines Buchbesitzers bzw. einer Buchbesitzerin verantwortlich ist, das in der Regel auf die Innenseite des vorderen Buchdeckels geklebt wird.' } },
      { '@id': 'role:bsl', 'skos:prefLabel': { 'eng': 'Bookseller', 'deu': 'Buchhändler*in', 'ita': 'Libraio' }, 'skos:definition': {  'eng': 'A person or organization who makes books and other bibliographic materials available for purchase. Interest in the materials is primarily lucrative.',  'deu': 'Eine Person oder Organisation, die Bücher und andere bibliografische Materialien zum Kauf anbietet. Das Interesse an diesen Materialien ist in erster Linie lukrativ.' } },
      { '@id': 'role:brl', 'skos:prefLabel': { 'eng': 'Braille embosser', 'deu': 'Brailledrucker*in', 'ita': 'Groffatore braille' }, 'skos:definition': {  'eng': 'A person, family, or organization involved in manufacturing a resource by embossing Braille cells using a stylus, special embossing printer, or other device.',  'deu': 'Eine Person, Familie oder Organisation, die an der Herstellung eines Hilfsmittels beteiligt ist, indem sie Braille-Zellen mit einem Stift, einem speziellen Prägedrucker oder einem anderen Gerät prägt.' } },
      { '@id': 'role:brd', 'skos:prefLabel': { 'eng': 'Broadcaster', 'deu': 'Rundfunkveranstalter*in', 'ita': 'Annunciatore' }, 'skos:definition': {  'eng': 'A person, family, or organization involved in broadcasting a resource to an audience via radio, television, webcast, etc.',  'deu': 'Eine Person, Familie oder Organisation, die eine Ressource über Radio, Fernsehen, Webcast usw. an ein Publikum sendet.' } },
      { '@id': 'role:cll', 'skos:prefLabel': { 'eng': 'Calligrapher', 'deu': 'Kalligraph*in', 'ita': 'Calligrafo' }, 'skos:definition': {  'eng': 'A person or organization who writes in an artistic hand, usually as a copyist and or engrosser.',  'deu': 'Eine Person oder Organisation, die mit einer künstlerischen Handschrift schreibt, in der Regel als Kopist*in und/oder Engrosschreiber*in.' } },
      ...
      { '@id': 'role:cli', 'skos:prefLabel': { 'eng': 'Client', 'deu': 'Auftraggeber*in', 'ita': 'Cliente' }, 'skos:definition': {  'eng': 'A person or organization for whom another person or organization is acting.',  'deu': 'Eine Person oder Organisation, für die eine andere Person oder Organisation tätig ist.' } },
      { '@id': 'role:coadvisor', 'skos:prefLabel': { 'eng': 'Co-Advisor', 'deu': 'Mitbetreuer*in der Hochschulschrift', 'ita': 'Correlatore' }, 'skos:definition': { 'eng': 'A person or organisation who shares advising responsibilities with another advisor or organisation for a university thesis or project.', 'deu': 'Eine Person oder Organisation, die gemeinsam mit einer anderen Person oder Organisation für die Betreuung einer Hochschulschrift oder eines Forschungsprojekts zuständig ist.' } },
      { '@id': 'role:cor', 'skos:prefLabel': { 'eng': 'Collection registrar', 'deu': 'Registrar*in', 'ita': 'Archivista della collezione' }, 'skos:definition': {  'eng': 'A curator who lists or inventories the items in an aggregate work such as a collection of items or works.',  'deu': 'Ein*e Kurator*in, der die Gegenstände in einem Gesamtwerk wie einer Sammlung von Gegenständen oder Werken auflistet oder inventarisiert.' } },
      ...
      { '@id': 'role:cmm', 'skos:prefLabel': { 'eng': 'Commentator', 'deu': 'Kommentator*in', 'ita': 'Commentatore di audiovisivi' }, 'skos:definition': {  'eng': 'A performer contributing to a work by providing interpretation, analysis, or a discussion of the subject matter on a recording, film, or other audiovisual medium.',  'deu': 'Ein*e ausübende*r Künstler*in, der bzw. die einen Beitrag zu einem Werk leistet, indem er bzw. sie eine Interpretation, Analyse oder Diskussion des Themas auf einer Aufnahme, einem Film oder einem anderen audiovisuellen Medium liefert.' } },
      { '@id': 'role:cwt', 'skos:prefLabel': { 'eng': 'Commentator for written text', 'deu': 'Kommentator*in eines geschriebenen Textes', 'ita': 'Commentatore di testo scritto' }, 'skos:definition': {  'eng': 'A person or organization responsible for the commentary or explanatory notes about a text. For the writer of manuscript annotations in a printed book, use Annotator.',  'deu': 'Eine Person oder Organisation, die für Kommentare oder Erläuterungen zu einem Text verantwortlich ist. Für den bzw. die Verfasser*in von handschriftlichen Anmerkungen in einem gedruckten Buch, verwenden Sie Annotator*in.' } },
      ...
      { '@id': 'role:dnc', 'skos:prefLabel': { 'eng': 'Dancer', 'deu': 'Tänzer*in', 'ita': 'Ballerino' }, 'skos:definition': {  'eng': 'A performer who dances in a musical, dramatic, etc., presentation.',  'deu': 'Ein*e Darsteller*in, der bzw. die in einer musikalischen, dramatischen usw. Präsentation tanzt.' } },
      { '@id': 'role:dtc', 'skos:prefLabel': { 'eng': 'Data contributor', 'deu': 'Datenlieferant*in', 'ita': 'Fornitore di dati' }, 'skos:definition': {  'eng': 'A person or organization that submits data for inclusion in a database or other collection of data.',  'deu': 'Eine Person oder Organisation, die Daten zur Aufnahme in eine Datenbank oder eine andere Datensammlung einreicht.' } },
      { '@id': 'role:dtm', 'skos:prefLabel': { 'eng': 'Data manager', 'deu': 'Datenmanager*in', 'ita': 'Gestore dei dati' }, 'skos:definition': {  'eng': 'A person or organization responsible for managing databases or other data sources.',  'deu': 'Eine Person oder Organisation, die für die Verwaltung von Datenbanken oder anderen Datenquellen zuständig ist.' } },
      ...
      { '@id': 'role:dgg', 'skos:prefLabel': { 'eng': 'Degree granting institution', 'deu': 'Verleihende Institution des akademischen Abschlusses', 'ita': 'Conferitore di titolo accademico' }, 'skos:definition': {  'eng': 'A organization granting an academic degree.',  'deu': 'Eine Organisation, die einen akademischen Grad verleiht.' } },
      { '@id': 'role:dgs', 'skos:prefLabel': { 'eng': 'Degree supervisor', 'deu': 'Betreuer*in der Hochschulschrift', 'ita': 'Supervisore di titolo accademico' }, 'skos:definition': {  'eng': 'A person overseeing a higher level academic degree.',  'deu': 'Eine Person, die für einen höheren akademischen Grad verantwortlich ist.' } },
      { '@id': 'role:dln', 'skos:prefLabel': { 'eng': 'Delineator', 'deu': 'Entwurfszeichner*in', 'ita': 'Delineatore' }, 'skos:definition': {  'eng': 'A person or organization executing technical drawings from others\' designs.',  'deu': 'Eine Person oder Organisation, die technische Zeichnungen nach Entwürfen anderer ausführt.' } },
      { '@id': 'role:dpc', 'skos:prefLabel': { 'eng': 'Depicted', 'deu': 'Dargestellt / beschrieben', 'ita': 'Dipinto' }, 'skos:definition': {  'eng': 'An entity depicted or portrayed in a work, particularly in a work of art.',  'deu': 'Ein Wesen, das in einem Werk, insbesondere in einem Kunstwerk, dargestellt wird.' } },
      { '@id': 'role:dpt', 'skos:prefLabel': { 'eng': 'Depositor', 'deu': 'Depositor*in', 'ita': 'Depositante' }, 'skos:definition': {  'eng': 'A current owner of an item who deposited the item into the custody of another person, family, or organization, while still retaining ownership.',  'deu': 'Ein*e derzeitige*r Eigentümer*in eines Gegenstands, der bzw. die den Gegenstand in die Obhut einer anderen Person, Familie oder Organisation gegeben hat, wobei er bzw. sie weiterhin Eigentümer*in bleibt.' } },
      { '@id': 'role:dsr', 'skos:prefLabel': { 'eng': 'Designer', 'deu': 'Designer*in', 'ita': 'Disegnatore' }, 'skos:definition': {  'eng': 'A person, family, or organization responsible for creating a design for an object.',  'deu': 'Eine Person, Familie oder Organisation, die für den Entwurf eines Objekts verantwortlich ist.' } },
      ...
      { '@id': 'role:drt', 'skos:prefLabel': { 'eng': 'Director', 'deu': 'Produktionsleiter*in', 'ita': 'Regista' }, 'skos:definition': {  'eng': 'A person responsible for the general management and supervision of a filmed performance, a radio or television program, etc.',  'deu': 'Eine Person, die für die allgemeine Leitung und Überwachung einer gefilmten Aufführung, einer Radio- oder Fernsehsendung usw. verantwortlich ist.' } },
      { '@id': 'role:dis', 'skos:prefLabel': { 'eng': 'Dissertant', 'deu': 'Verfasser*in der Hochschulschrift', 'ita': 'Autore della dissertazione' }, 'skos:definition': {  'eng': 'A person who presents a thesis for a university or higher-level educational degree.',  'deu': 'Eine Person, die eine Abschlussarbeit für eine Universität oder einen höheren Bildungsabschluss vorlegt.' } },
      { '@id': 'role:dbp', 'skos:prefLabel': { 'eng': 'Distribution place', 'deu': 'Vertriebsort', 'ita': 'Luogo di distribuzione' }, 'skos:definition': {  'eng': 'A place from which a resource, e.g., a serial, is distributed.',  'deu': 'Ein Ort, von dem aus eine Ressource, z. B. eine Serie, verteilt wird.' } },
      ...
      { '@id': 'role:drm', 'skos:prefLabel': { 'eng': 'Draftsman', 'deu': 'Technische/r Zeichner*in', 'ita': 'Progettista' }, 'skos:definition': {  'eng': 'A person, family, or organization contributing to a resource by an architect, inventor, etc., by making detailed plans or drawings for buildings, ships, aircraft, machines, objects, etc.',  'deu': 'Eine Person, Familie oder Organisation, die zu einer Ressource eines Architekten, Erfinders usw. beiträgt, indem sie detaillierte Pläne oder Zeichnungen für Gebäude, Schiffe, Flugzeuge, Maschinen, Gegenstände usw. anfertigt.' } },
      ...
      { '@id': 'role:exp', 'skos:prefLabel': { 'eng': 'Expert', 'deu': 'Expert*in / Sachverständige/r', 'ita': 'Perito' }, 'skos:definition': {  'eng': 'A person or organization in charge of the description and appraisal of the value of goods, particularly rare items, works of art, etc.',  'deu': 'Eine Person oder Organisation, die mit der Beschreibung und Schätzung des Wertes von Waren, insbesondere von seltenen Gegenständen, Kunstwerken usw. beauftragt ist.' } },
      { '@id': 'role:fac', 'skos:prefLabel': { 'eng': 'Facsimilist', 'deu': 'Ersteller*in des Faksimile', 'ita': 'Facsimilista' }, 'skos:definition': {  'eng': 'A person or organization that executed the facsimile.',  'deu': 'Eine Person oder Organisation, die das Faksimile erstellt hat.' } },
      ...
      { '@id': 'role:frg', 'skos:prefLabel': { 'eng': 'Forger', 'deu': 'Fälscher*in', 'ita': 'Falsificatore' }, 'skos:definition': {  'eng': 'A person or organization who makes or imitates something of value or importance, especially with the intent to defraud.',  'deu': 'Eine Person oder Organisation, die etwas von Wert oder Bedeutung herstellt oder nachahmt, insbesondere in der Absicht, zu betrügen.' } },
      ...
      { '@id': 'role:fon', 'skos:prefLabel': { 'eng': 'Founder', 'deu': 'Gründer*in', 'ita': 'Fondatore' }, 'skos:definition': { 'eng': 'A person or organisation who played a significant role in initiating, establishing, or creating a particular entity, project, or endeavor.', 'deu': 'Eine Person oder Organisation, die eine bedeutende Rolle bei der Initiierung, Gründung oder Schaffung einer bestimmten Entität, eines Projekts oder einer Unternehmung gespielt hat.' } },
      { '@id': 'role:fnd', 'skos:prefLabel': { 'eng': 'Funder', 'deu': 'Geldgeber*in', 'ita': 'Finanziatore' }, 'skos:definition': {  'eng': 'A person or organization that furnished financial support for the production of the work.',  'deu': 'Eine Person oder Organisation, die die Produktion des Werks finanziell unterstützt hat.' } },
      { '@id': 'role:gis', 'skos:prefLabel': { 'eng': 'Geographic information specialist', 'deu': 'Spezialist*in für geografische Informationen', 'ita': 'Specialista di informazioni territoriali' }, 'skos:definition': {  'eng': 'A person responsible for geographic information system (GIS) development and integration with global positioning system data.',  'deu': 'Eine Person, die für die Entwicklung von geografischen Informationssystemen (GIS) und die Integration mit Daten des globalen Positionierungssystems verantwortlich ist.' } },
      ...
      { '@id': 'role:ins', 'skos:prefLabel': { 'eng': 'Inscriber', 'deu': 'Widmende/r', 'ita': 'Firmatario del dono' }, 'skos:definition': {  'eng': 'A person who has written a statement of dedication or gift.',  'deu': 'Eine Person, die eine Widmungs- oder Schenkungserklärung verfasst hat.' } },
      { '@id': 'role:itr', 'skos:prefLabel': { 'eng': 'Instrumentalist', 'deu': 'Instrumentalist*in', 'ita': 'Strumentista' }, 'skos:definition': {  'eng': 'A performer contributing to a resource by playing a musical instrument.',  'deu': 'Ein*e Künstler*in, der bzw. die durch das Spielen eines Musikinstruments zu einer Ressource beiträgt.' } },
      { '@id': 'role:interpreter', 'skos:prefLabel': { 'eng': 'Interpreter', 'deu': 'Dolmetscher*in', 'ita': 'Interprete (lingua)' }, 'skos:definition': { 'eng': 'A person who translates spoken or signed language from one language to another (in real-time settings or for recorded or delayed communication).', 'deu': 'Eine Person, die gesprochene oder gebärdete Sprache von einer Sprache in eine andere übersetzt (in Echtzeit oder für aufgezeichnete oder verzögerte Kommunikation).' } },
      ...
      { '@id': 'role:inv', 'skos:prefLabel': { 'eng': 'Inventor', 'deu': 'Erfinder*in', 'ita': 'Inventore' }, 'skos:definition': {  'eng': 'A person, family, or organization responsible for creating a new device or process.',  'deu': 'Eine Person, Familie oder Organisation, die für die Entwicklung eines neuen Geräts oder Verfahrens verantwortlich ist.' } },
      ...
      { '@id': 'role:lbr', 'skos:prefLabel': { 'eng': 'Laboratory', 'deu': 'Labor', 'ita': 'Laboratorio' }, 'skos:definition': {  'eng': 'An organization that provides scientific analyses of material samples.',  'deu': 'Eine Organisation, die wissenschaftliche Analysen von Materialproben durchführt.' } },
      { '@id': 'role:ldr', 'skos:prefLabel': { 'eng': 'Laboratory director', 'deu': 'Laborleiter*in', 'ita': 'Direttore di laboratorio' }, 'skos:definition': {  'eng': 'A person or organization that manages or supervises work done in a controlled setting or environment.',  'deu': 'Eine Person oder Organisation, die die Arbeit in einem kontrollierten Umfeld leitet oder beaufsichtigt.' } },
      { '@id': 'role:lsa', 'skos:prefLabel': { 'eng': 'Landscape architect', 'deu': 'Landschaftsarchitekt*in', 'ita': 'Architetto del paesaggio' }, 'skos:definition': {  'eng': 'An architect responsible for creating landscape works. This work involves coordinating the arrangement of existing and proposed land features and structures.',  'deu': 'Ein*e Architekt*in, der bzw. die für die Gestaltung von Landschaftswerken verantwortlich ist. Diese Arbeit umfasst die Koordinierung der Anordnung von bestehenden und geplanten Landschaftselementen und Strukturen.' } },
      { '@id': 'role:led', 'skos:prefLabel': { 'eng': 'Lead', 'deu': 'Leitung', 'ita': 'Capo' }, 'skos:definition': {  'eng': 'A person or organization that takes primary responsibility for a particular activity or endeavor. May be combined with another relator term or code to show the greater importance this person or organization has regarding that particular role. If more than one relator is assigned to a heading, use the Lead relator only if it applies to all the relators.',  'deu': 'Eine Person oder Organisation, die die Hauptverantwortung für eine bestimmte Aktivität oder ein bestimmtes Unterfangen trägt. Kann mit einem anderen Beauftragtenbegriff oder -code kombiniert werden, um die größere Bedeutung dieser Person oder Organisation in Bezug auf diese spezielle Rolle zu verdeutlichen. Wenn einer Rubrik mehr als ein Verantwortlicher bzw. eine Verantwortliche zugeordnet ist, verwenden Sie den Begriff "Hauptverantwortliche*r" nur, wenn er auf alle Verantwortlichen zutrifft.' } },
      { '@id': 'role:len', 'skos:prefLabel': { 'eng': 'Lender', 'deu': 'Leihgeber', 'ita': 'Prestatore' }, 'skos:definition': {  'eng': 'A person or organization permitting the temporary use of a book, manuscript, etc., such as for photocopying or microfilming.',  'deu': 'Eine Person oder Organisation, die die vorübergehende Nutzung eines Buches, Manuskripts usw. gestattet, z. B. zum Fotokopieren oder Mikroverfilmen.' } },
      ...
      { '@id': 'role:lse', 'skos:prefLabel': { 'eng': 'Licensee', 'deu': 'Lizenznehmer*in', 'ita': 'Licenziatario' }, 'skos:definition': {  'eng': 'A person or organization who is an original recipient of the right to print or publish.',  'deu': 'Eine Person oder Organisation, die das ursprüngliche Druck- oder Veröffentlichungsrecht erhalten hat.' } },
      { '@id': 'role:lso', 'skos:prefLabel': { 'eng': 'Licensor', 'deu': 'Lizenzgeber*in', 'ita': 'Licenziatore' }, 'skos:definition': {  'eng': 'A person or organization who is a signer of the license, imprimatur, etc.',  'deu': 'Eine Person oder Organisation, die eine Lizenz, ein Imprimatur usw. unterzeichnet.' } },
      ...
      { '@id': 'role:mfp', 'skos:prefLabel': { 'eng': 'Manufacture place', 'deu': 'Herstellungsort', 'ita': 'Luogo di manifattura' }, 'skos:definition': {  'eng': 'The place of manufacture (e.g., printing, duplicating, casting, etc.) of a resource in a published form.',  'deu': 'Der Ort der Herstellung (z. B. Druck, Vervielfältigung, Gießen usw.) einer Ressource in einer veröffentlichten Form.' } },
      { '@id': 'role:mfr', 'skos:prefLabel': { 'eng': 'Manufacturer', 'deu': 'Hersteller*in', 'ita': 'Manifattore' }, 'skos:definition': {  'eng': 'A person or organization responsible for printing, duplicating, casting, etc. a resource.',  'deu': 'Eine Person oder Organisation, die für das Drucken, Vervielfältigen, Gießen usw. einer Ressource verantwortlich ist.' } },
      { '@id': 'role:mrb', 'skos:prefLabel': { 'eng': 'Marbler', 'deu': 'Marmorier*in', 'ita': 'Marmorizzatore' }, 'skos:definition': {  'eng': 'The entity responsible for marbling paper, cloth, leather, etc. used in construction of a resource.',  'deu': 'Die Einheit, die für die Marmorierung von Papier, Stoff, Leder usw. zuständig ist, die für den Bau einer Ressource verwendet werden.' } },
      { '@id': 'role:mrk', 'skos:prefLabel': { 'eng': 'Markup editor', 'deu': 'Markup-Editor*in', 'ita': 'Curatore del markup' }, 'skos:definition': {  'eng': 'A person or organization performing the coding of SGML, HTML, or XML markup of metadata, text, etc.',  'deu': 'Eine Person oder Organisation, die die Kodierung von SGML-, HTML- oder XML-Auszeichnungen von Metadaten, Text usw. vornimmt.' } },
      ...
      { '@id': 'role:mon', 'skos:prefLabel': { 'eng': 'Monitor', 'deu': 'Vertragsprüfer*in', 'ita': 'Garante' }, 'skos:definition': {  'eng': 'A person or organization that supervises compliance with the contract and is responsible for the report and controls its distribution. Sometimes referred to as the grantee, or controlling agency.',  'deu': 'A person or organization that supervises compliance with the contract and is responsible for the report and controls its distribution. Sometimes referred to as the grantee, or controlling agency.' } },
      { '@id': 'role:mcp', 'skos:prefLabel': { 'eng': 'Music copyist', 'deu': 'Musikkopist*in', 'ita': 'Copista di musica' }, 'skos:definition': {  'eng': 'A person who transcribes or copies musical notation.',  'deu': 'Eine Person oder Organisation, die die Einhaltung des Vertrags überwacht, für den Bericht verantwortlich ist und dessen Verteilung kontrolliert. Wird manchmal auch als Zuschussempfänger*in oder Kontrollstelle bezeichnet.' } },
      ...
      { '@id': 'role:orm', 'skos:prefLabel': { 'eng': 'Organizer', 'deu': 'Veranstalter*in', 'ita': 'Organizzatore della riunione' }, 'skos:definition': {  'eng': 'A person, family, or organization organizing the exhibit, event, conference, etc., which gave rise to a resource.',  'deu': 'Eine Person, Familie oder Organisation, die die Ausstellung, Veranstaltung, Konferenz usw. organisiert, aus der eine Ressource hervorgegangen ist.' } },
      ...
      { '@id': 'role:pop', 'skos:prefLabel': { 'eng': 'Printer of plates', 'deu': 'Plattendrucker*in', 'ita': 'Stampatore delle tavole' }, 'skos:definition': {  'eng': 'A person or organization who prints illustrations from plates.',  'deu': 'Eine Person oder Organisation, die Illustrationen von Platten druckt.' } },
      { '@id': 'role:prm', 'skos:prefLabel': { 'eng': 'Printmaker', 'deu': 'Druckplattenhersteller*in (Tief-, Hoch-, Flachdruck)', 'ita': 'Produttore degli stampi' }, 'skos:definition': {  'eng': 'A person or organization who makes a relief, intaglio, or planographic printing surface.',  'deu': 'Eine Person oder Organisation, die eine Relief-, Tiefdruck- oder Flachdruckoberfläche herstellt.' } },
      { '@id': 'role:prc', 'skos:prefLabel': { 'eng': 'Process contact', 'deu': 'Ansprechpartner*in', 'ita': 'Responsabile del procedimento' }, 'skos:definition': {  'eng': 'A person or organization primarily responsible for performing or initiating a process, such as is done with the collection of metadata sets.',  'deu': 'Eine Person oder Organisation, die in erster Linie für die Durchführung oder Initiierung eines Prozesses verantwortlich ist, wie z. B. bei der Sammlung von Metadatensätzen.' } },
      ...
      { '@id': 'role:prn', 'skos:prefLabel': { 'eng': 'Production company', 'deu': 'Produktionsfirma', 'ita': 'Società di produzione' }, 'skos:definition': {  'eng': 'An organization that is responsible for financial, technical, and organizational management of a production for stage, screen, audio recording, television, webcast, etc.',  'deu': 'Eine Organisation, die für das finanzielle, technische und organisatorische Management einer Produktion für Bühne, Leinwand, Tonaufnahme, Fernsehen, Webcast usw. verantwortlich ist.' } },
      { '@id': 'role:prp', 'skos:prefLabel': { 'eng': 'Production place', 'deu': 'Produktionsort', 'ita': 'Luogo di produzione' }, 'skos:definition': {  'eng': 'The place of production (e.g., inscription, fabrication, construction, etc.) of a resource in an unpublished form.',  'deu': 'Der Ort, an dem eine Ressource in unveröffentlichter Form hergestellt wurde (z. B. Eintragung, Herstellung, Konstruktion usw.).' } },
      { '@id': 'role:prs', 'skos:prefLabel': { 'eng': 'Production designer', 'deu': 'Produktionsdesigner*in', 'ita': 'Designer di produzione' }, 'skos:definition': {  'eng': 'A person or organization responsible for designing the overall visual appearance of a moving image production.',  'deu': 'Eine Person oder Organisation, die für die Gestaltung des gesamten visuellen Erscheinungsbildes einer Bewegtbildproduktion verantwortlich ist.' } },
      { '@id': 'role:pmn', 'skos:prefLabel': { 'eng': 'Production manager', 'deu': 'Produktionsmanager*in', 'ita': 'Direttore di produzione' }, 'skos:definition': {  'eng': 'A person responsible for all technical and business matters in a production.',  'deu': 'Eine Person, die für alle technischen und geschäftlichen Angelegenheiten einer Produktion verantwortlich ist.' } },
      { '@id': 'role:prd', 'skos:prefLabel': { 'eng': 'Production personnel', 'deu': 'Produktionspersonal', 'ita': 'Personale di produzione' }, 'skos:definition': {  'eng': 'A person or organization associated with the production (props, lighting, special effects, etc.) of a musical or dramatic presentation or entertainment.',  'deu': 'Eine Person oder Organisation, die an der Produktion (Requisiten, Beleuchtung, Spezialeffekte usw.) einer musikalischen oder dramatischen Darbietung oder Unterhaltung beteiligt ist.' } },
      { '@id': 'role:prg', 'skos:prefLabel': { 'eng': 'Programmer', 'deu': 'Programmierer*in', 'ita': 'Programmatore' }, 'skos:definition': {  'eng': 'A person, family, or organization responsible for creating a computer program.',  'deu': 'Eine Person, Familie oder Organisation, die für die Erstellung eines Computerprogramms verantwortlich ist.' } },
      { '@id': 'role:pdr', 'skos:prefLabel': { 'eng': 'Project director', 'deu': 'Projektleiter*in', 'ita': 'Direttore di progetto' }, 'skos:definition': {  'eng': 'A person or organization with primary responsibility for all essential aspects of a project, has overall responsibility for managing projects, or provides overall direction to a project manager.',  'deu': 'Eine Person oder Organisation, die die Hauptverantwortung für alle wesentlichen Aspekte eines Projekts trägt, die Gesamtverantwortung für das Management von Projekten hat oder einem Projektmanager bzw. einer Projektmanagerin die Gesamtleitung überträgt.' } },
      { '@id': 'role:pfr', 'skos:prefLabel': { 'eng': 'Proofreader', 'deu': 'Lektor*in', 'ita': 'Correttore di bozze' }, 'skos:definition': {  'eng': 'A person who corrects printed matter. For manuscripts, use Corrector [crr].',  'deu': 'Eine Person, die Drucksachen korrigiert. Für Manuskripte verwenden Sie Korrektor*in.' } },
      { '@id': 'role:prv', 'skos:prefLabel': { 'eng': 'Provider', 'deu': 'Anbieter*in / Lieferant*in', 'ita': 'Fornitore' }, 'skos:definition': {  'eng': 'A person or organization who produces, publishes, manufactures, or distributes a resource if specific codes are not desired (e.g. [mfr], [pbl]).',  'deu': 'Eine Person oder Organisation, die eine Ressource produziert, veröffentlicht, herstellt oder vertreibt, wenn keine spezifischen Bezeichnungen gewünscht sind (z. B. Hersteller*in, Verleger*in).' } },
      ...
      { '@id': 'role:pbd', 'skos:prefLabel': { 'eng': 'Publishing director', 'deu': 'Verlagsleiter*in', 'ita': 'Direttore editoriale' }, 'skos:definition': {  'eng': 'A person or organization who presides over the elaboration of a collective work to ensure its coherence or continuity. This includes editors-in-chief, literary editors, editors of series, etc.',  'deu': 'Eine Person oder Organisation, die bei der Ausarbeitung eines kollektiven Werks den Vorsitz führt, um dessen Kohärenz oder Kontinuität zu gewährleisten. Dazu gehören Chefredakteur*innen, literarische Redakteur*innen, Redakteur*innen von Serien usw.' } },
      { '@id': 'role:ppt', 'skos:prefLabel': { 'eng': 'Puppeteer', 'deu': 'Puppenspieler*in', 'ita': 'Burattinaio' }, 'skos:definition': {  'eng': 'A performer contributing to a resource by manipulating, controlling, or directing puppets or marionettes in a moving image production or a musical or dramatic presentation or entertainment.',  'deu': 'Ein*e Darsteller*in, der bzw. die zu einer Ressource beiträgt, indem er bzw. sie Puppen oder Marionetten in einer Bewegtbildproduktion oder einer musikalischen oder dramatischen Präsentation oder Unterhaltung manipuliert, kontrolliert oder anleitet.' } },
      { '@id': 'role:rdd', 'skos:prefLabel': { 'eng': 'Radio director', 'deu': 'Radio-, Hörfunkdirektor*in', 'ita': 'Regista radiofonico' }, 'skos:definition': {  'eng': 'A director responsible for the general management and supervision of a radio program.',  'deu': 'Ein*e Regisseur*in, der bzw. die für die allgemeine Verwaltung und Überwachung eines Radioprogramms verantwortlich ist.' } },
      { '@id': 'role:rpc', 'skos:prefLabel': { 'eng': 'Radio producer', 'deu': 'Radioproduzent*in', 'ita': 'Produttore radiofonico' }, 'skos:definition': {  'eng': 'A producer responsible for most of the business aspects of a radio program.',  'deu': 'Ein*e Produzent*in, der bzw. die für die meisten geschäftlichen Aspekte eines Radioprogramms verantwortlich ist.' } },
      ...
      { '@id': 'role:rbr', 'skos:prefLabel': { 'eng': 'Rubricator', 'deu': 'Rubrikator*in', 'ita': 'Rubricatore' }, 'skos:definition': {  'eng': 'A person or organization responsible for parts of a work, often headings or opening parts of a manuscript, that appear in a distinctive color, usually red.',  'deu': 'Eine Person oder Organisation, die für Teile eines Werks verantwortlich ist, oft Überschriften oder einleitende Teile eines Manuskripts, die in einer charakteristischen Farbe, meist rot, erscheinen.' } },
      ...
      { '@id': 'role:spy', 'skos:prefLabel': { 'eng': 'Second party', 'deu': 'Zweite Vertragspartei', 'ita': 'Cessionario' }, 'skos:definition': {  'eng': 'A person or organization who is identified as the party of the second part. In the case of transfer of right, this is the assignee, transferee, licensee, grantee, etc. Multiple parties can be named jointly as the second party.', 'deu': 'Eine Person oder Organisation, die als die Vertragspartei des zweiten Teils identifiziert wird. Bei der Übertragung von Rechten ist dies der bzw. die Abtretungsempfänger*in, der bzw. die Übernehmer*in, der bzw. die Lizenznehmer*in, der bzw. die Begünstigte, usw. Mehrere Parteien können gemeinsam als zweite Vertragspartei benannt werden.' } },
      { '@id': 'role:sec', 'skos:prefLabel': { 'eng': 'Secretary', 'deu': 'Sekretär*in (Funktion)', 'ita': 'Segretario' }, 'skos:definition': {  'eng': 'A person or organization who is a recorder, redactor, or other person responsible for expressing the views of a organization.',  'deu': 'Eine Person oder Organisation, die als Protokollant, Redakteur oder sonstiger Verantwortlicher für den Ausdruck der Ansichten einer Organisation fungiert.' } },
      { '@id': 'role:sll', 'skos:prefLabel': { 'eng': 'Seller', 'deu': 'Verkäufer*in', 'ita': 'Venditore' }, 'skos:definition': {  'eng': 'A former owner of an item who sold that item to another owner.',  'deu': 'Ein*e ehemalige*r Eigentümer*in eines Gegenstandes, der bzw. die diesen Gegenstand an eine*n andere*n Eigentümer*in verkauft hat.' } },
      { '@id': 'role:std', 'skos:prefLabel': { 'eng': 'Set designer', 'deu': 'Bühnenbildner*in / Filmarchitekt', 'ita': 'Scenografo' }, 'skos:definition': {  'eng': 'A person who translates the rough sketches of the art director into actual architectural structures for a theatrical presentation, entertainment, motion picture, etc. Set designers draw the detailed guides and specifications for building the set.',  'deu': 'Eine Person, die die groben Skizzen des künstlerischen Leiters bzw. der künstlerischen Leiterin in tatsächliche architektonische Strukturen für eine Theatervorstellung, Unterhaltung, einen Film usw. umsetzt. Bühnenbildner*innen zeichnen die detaillierten Anleitungen und Spezifikationen für den Bau des Bühnenbilds.' } },
      ...
      { '@id': 'role:sds', 'skos:prefLabel': { 'eng': 'Sound designer', 'deu': 'Sounddesigner*in', 'ita': 'Designer del suono' }, 'skos:definition': {  'eng': 'A person who produces and reproduces the sound score (both live and recorded), the installation of microphones, the setting of sound levels, and the coordination of sources of sound for a production.',  'deu': 'Eine Person, die den Soundtrack (sowohl live als auch aufgenommen) produziert und reproduziert, die Mikrofone installiert, die Lautstärke einstellt und die Tonquellen für eine Produktion koordiniert.' } },
      { '@id': 'role:spk', 'skos:prefLabel': { 'eng': 'Speaker / Lecturer', 'deu': 'Sprecher*in / Vortragende/r', 'ita': 'Oratore' }, 'skos:definition': {  'eng': 'A performer contributing to a resource by speaking words, such as a lecture, speech, etc.',  'deu': 'Ein*e Darsteller*in, der bzw. die zu einer Ressource beiträgt, indem er bzw. die Worte spricht, z. B. bei einem Vortrag, einer Rede usw.' } },
      ...
      { '@id': 'role:sgd', 'skos:prefLabel': { 'eng': 'Stage director', 'deu': 'Theaterregisseur*in', 'ita': 'Regista teatrale' }, 'skos:definition': {  'eng': 'A person or organization contributing to a stage resource through the overall management and supervision of a performance.',  'deu': 'Eine Person oder Organisation, die durch das Gesamtmanagement und die Aufsicht über eine Aufführung zu einer Bühnenressource beiträgt.' } },
      { '@id': 'role:stm', 'skos:prefLabel': { 'eng': 'Stage manager', 'deu': 'Inspizient*in / Bühnenmeister*in', 'ita': 'Direttore di scena' }, 'skos:definition': {  'eng': 'A person who is in charge of everything that occurs on a performance stage, and who acts as chief of all crews and assistant to a director during rehearsals.',  'deu': 'Eine Person, die für alles verantwortlich ist, was auf einer Aufführungsbühne passiert, und die als Chef*in aller Crews und Assistent*in eines Regisseurs bzw. einer Regisseurin während der Proben fungiert.' } },
      { '@id': 'role:stn', 'skos:prefLabel': { 'eng': 'Standards body', 'deu': 'Normkomitee', 'ita': 'Ente di standardizzazione' }, 'skos:definition': {  'eng': 'An organization responsible for the development or enforcement of a standard.',  'deu': 'Eine Organisation, die für die Entwicklung oder Durchsetzung einer Norm verantwortlich ist.' } },
      { '@id': 'role:str', 'skos:prefLabel': { 'eng': 'Stereotyper', 'deu': 'Stereotypieplattenhersteller', 'ita': 'Stereotipista' }, 'skos:definition': {  'eng': 'A person or organization who creates a new plate for printing by molding or copying another printing surface.',  'deu': 'Eine Person oder Organisation, die eine neue Druckplatte durch Abformen oder Kopieren einer anderen Druckoberfläche herstellt.' } },
      { '@id': 'role:stl', 'skos:prefLabel': { 'eng': 'Storyteller', 'deu': 'Geschichtenerzähler', 'ita': 'Cantastorie' }, 'skos:definition': {  'eng': 'A performer contributing to a resource by relaying a creator\'s original story with dramatic or theatrical interpretation.',  'deu': 'Ein*e Darsteller*in, der bzw. die zu einer Ressource beiträgt, indem er bzw. sie die Originalgeschichte eines Schöpfers bzw. einer Schöpferin mit einer dramatischen oder theatralischen Interpretation wiedergibt.' } },
      ...
      { '@id': 'role:tch', 'skos:prefLabel': { 'eng': 'Teacher', 'deu': 'Lehrer*in', 'ita': 'Insegnante' }, 'skos:definition': {  'eng': 'A performer contributing to a resource by giving instruction or providing a demonstration.',  'deu': 'Ein*e Darsteller*in, der bzw. die zu einer Ressource beiträgt, indem er bzw. sie Anweisungen gibt oder eine Demonstration anbietet.' } },
      { '@id': 'role:student', 'skos:prefLabel': { 'eng': 'Student', 'deu': 'Schüler*in', 'ita': 'Studente' }, 'skos:definition': {  'eng': 'A person contributing to a resource by learning, studying, or participating in an educational activity.',  'deu': 'Eine Person, die zu einer Ressource beiträgt, indem sie lernt, studiert oder an einer Bildungsaktivität teilnimmt.',  'ita': 'Una persona che contribuisce a una risorsa imparando, studiando o partecipando a un\'attività educativa.' } },
      ...
      { '@id': 'role:tld', 'skos:prefLabel': { 'eng': 'Television director', 'deu': 'Fernsehintendant*in', 'ita': 'Regista televisivo' }, 'skos:definition': {  'eng': 'A director responsible for the general management and supervision of a television program.',  'deu': 'Eine Regisseur*in, der bzw. die für die allgemeine Verwaltung und Überwachung eines Fernsehprogramms verantwortlich ist.' } },
      { '@id': 'role:tlp', 'skos:prefLabel': { 'eng': 'Television producer', 'deu': 'Fernsehproduzent*in', 'ita': 'Produttore televisivo' }, 'skos:definition': {  'eng': 'A producer responsible for most of the business aspects of a television program.',  'deu': 'Eine Produzent*in, der bzw. die für die meisten geschäftlichen Aspekte eines Fernsehprogramms verantwortlich ist.' } },
      ...
      { '@id': 'role:ths', 'skos:prefLabel': { 'eng': 'Thesis advisor', 'deu': 'Dissertationsbetreuer*in', 'ita': 'Relatore di tesi' }, 'skos:definition': {  'eng': 'A person under whose supervision a degree candidate develops and presents a thesis, mémoire, or text of a dissertation.',  'deu': 'Eine Person, unter deren Aufsicht ein*e Kandidat*in eine Dissertation, ein Mémoire oder einen Dissertationstext erarbeitet und vorlegt.' } },
      { '@id': 'role:trc', 'skos:prefLabel': { 'eng': 'Transcriber', 'deu': 'Transkriptor*in von Noten', 'ita': 'Trascrittore' }, 'skos:definition': {  'eng': 'A person, family, or organization contributing to a resource by changing it from one system of notation to another. For a work transcribed for a different instrument or performing group, see Arranger [arr]. For makers of pen-facsimiles, use Facsimilist [fac].',  'deu': 'Eine Person, Familie oder Organisation, die zu einer Ressource beiträgt, indem sie sie von einem Notationssystem in ein anderes umwandelt. Für ein Werk, das für ein anderes Instrument oder eine andere Ausführungsgruppe transkribiert wurde, siehe Arrangeur*in. Für Hersteller*innen von Stift-Faksimiles verwenden Sie Ersteller*in des Faksimile.' } },
      ...
      { '@id': 'role:tyd', 'skos:prefLabel': { 'eng': 'Type designer', 'deu': 'Schriftdesigner*in / Schriftentwerfer*in', 'ita': 'Disegnatore dei caratteri' }, 'skos:definition': {  'eng': 'A person or organization who designs the type face used in a particular item.',  'deu': 'Eine Person oder Organisation, die das für einen bestimmten Artikel verwendete Schriftbild entwirft.' } },
      ...
      { '@id': 'role:wam', 'skos:prefLabel': { 'eng': 'Writer of accompanying material', 'deu': 'Autor*in von Begleitmaterial', 'ita': 'Autore del materiale di accompagnamento' }, 'skos:definition': {  'eng': 'A person or organization who writes significant material which accompanies a sound recording or other audiovisual material.',  'deu': 'Eine Person oder Organisation, die aussagekräftiges Begleitmaterial zu einer Tonaufnahme oder einem anderen audiovisuellen Material schreibt.' } },
      ...
      { '@id': 'role:win', 'skos:prefLabel': { 'eng': 'Writer of introduction', 'deu': 'Autor*in der Einführung', 'ita': 'Scrittore dell\'introduzione' }, 'skos:definition': {  'eng': 'A person, family, or organization contributing to a resource by providing an introduction to the original work.',  'deu': 'Eine Person, Familie oder Organisation, die einen Beitrag zu einer Ressource leistet, indem sie eine Einführung in das Originalwerk liefert.' } },
      { '@id': 'role:wpr', 'skos:prefLabel': { 'eng': 'Writer of preface', 'deu': 'Autor*in des Vorwortes', 'ita': 'Scrittore della prefazione' }, 'skos:definition': {  'eng': 'A person, family, or organization contributing to a resource by providing a preface to the original work.',  'deu': 'Eine Person, Familie oder Organisation, die einen Beitrag zu einer Ressource leistet, indem sie ein Vorwort zum Originalwerk liefert.' } },
      { '@id': 'role:wst', 'skos:prefLabel': { 'eng': 'Writer of supplementary textual content', 'deu': 'Autor*in von ergänzendem Textinhalt', 'ita': 'Scrittore di contenuto testuale supplementare' }, 'skos:definition': {  'eng': 'A person, family, or organization contributing to a resource by providing supplementary textual content (e.g., an introduction, a preface) to the original work.',  'deu': 'Eine Person, Familie oder Organisation, die einen Beitrag zu einer Ressource leistet, indem sie ergänzende Textinhalte (z. B. eine Einleitung, ein Vorwort) zum Originalwerk bereitstellt.' } }
    ],
    loaded: true
  },
  'irrolepredicate': {
    terms: [
      { '@id': 'role:aut', 'skos:prefLabel': { 'eng': 'Author', 'deu': 'Autor*in', 'ita': 'Autore' } },
      { '@id': 'role:edt', 'skos:prefLabel': { 'eng': 'Editor', 'deu': 'Herausgeber*in', 'ita': 'Curatore' } }
    ],
    loaded: true
  },
    ...
    terms: [
      {
        ...
        'skos:definition': {
          ...
          'ita': 'Se scegli Tutti i diritti riservati, il tuo oggetto può essere utilizzato solo nei limiti del diritto d\'autore. Inoltre, non autorizzi né un uso commerciale né un uso non commerciale, specialmente per quanto riguarda riprodurre, distribuire, comunicare al pubblico, esporre in pubblico, rappresentare, eseguire e recitare quest\'opera.\n<br />\n<br />\nScegliere una licenza Creative Commons promuove la diffusione della tua opera. Per ulteriori informazioni, consulta <a href=\'http://www.creativecommons.it\' target=\'_blank\'>http://www.creativecommons.it</a>.'
        }
      },
      {
      ...
      },
      {
        ...
        'skos:prefLabel': {
          ...
          'ita': 'CC BY-NC 4.0 Internazionale'
        },
        'img': 'cc-by-nc.png',
        'skos:definition': {
      ...
      },
      {
        ...
        'skos:prefLabel': {
          ...
          'ita': 'CC BY-NC-ND 4.0 Internazionale'
        },
        'img': 'cc-by-nc-nd.png',
        'skos:definition': {
      ...
      },
      {
        ...
        'skos:prefLabel': {
          ...
          'ita': 'CC BY-NC-SA 4.0 Internazionale'
        },
        'img': 'cc-by-nc-sa.png',
        'skos:definition': {
      ...
      },
      {
        ...
        'skos:prefLabel': {
          ...
          'ita': 'CC BY-ND 4.0 Internazionale'
        },
        'img': 'cc-by-nd.png',
        'skos:definition': {
      ...
      },
      {
        ...
        'skos:prefLabel': {
          ...
          'ita': 'CC BY-SA 4.0 Internazionale'
        },
        'img': 'cc-by-sa.png',
        'skos:definition': {
      ...
      },
      {
        ...
        'skos:prefLabel': {
          ...
          'ita': 'Marchio Pubblico Dominio 1.0'
        },
        'img': 'pdm.png',
        'skos:definition': {
  ...
  'accessibilityFeature': {
    terms: [
      ...
      { '@id': 'transcript', 'skos:prefLabel': { 'eng': 'transcript', 'deu': 'Transkription' }, 'skos:definition': { 'eng': 'Indicates that a transcript of the audio content is available.', 'deu': 'Zeigt an, dass eine Transkription des Audioinhalts verfügbar ist.' } },
  ...
  'levelofdescription': {
    terms: [
      { '@id': ns + 'HQ7N-3Q2W', 'skos:prefLabel': { 'eng': 'Digitized object', 'deu': 'Digitalisiertes Objekt', 'ita': 'Oggetto digitalizzato' } },
      { '@id': ns + 'TG30-5EM3', 'skos:prefLabel': { 'eng': 'Represented object', 'deu': 'Repräsentiertes Objekt', 'ita': 'Oggetto rappresentato' } }
    ],
    loaded: true
  },
  'carriertype': {
    terms: [
      ...
      { '@id': ns + 'HXSS-NBZ4', 'skos:prefLabel': { 'eng': 'audiocassette', 'deu': 'Audiokassette', 'ita': 'Audiocassetta' } },
      { '@id': ns + 'X627-FCV9', 'skos:prefLabel': { 'eng': 'tape', 'deu': 'Magnetband', 'ita': 'Nastro magnetico' } },
      { '@id': ns + 'C36Q-N42M', 'skos:prefLabel': { 'eng': 'lantern slide', 'deu': 'Glasplattendia', 'ita': 'Lastra da lanterna magica' } }
    ],
    loaded: true
  },
  'resourcetype': {
  ...
  'genre': {
    terms: [
      { '@id': ns + 'QNV1-N1EC', 'skos:prefLabel': { 'eng': 'action', 'deu': 'Actionfilm', 'ita':'Film d\'azione' } },
      { '@id': ns + '31DA-295K', 'skos:prefLabel': { 'eng': 'anime', 'deu': 'Anime', 'ita':'Film d\'animazione'} },
      { '@id': ns + 'DB5C-1Y4H', 'skos:prefLabel': { 'eng': 'biographical film', 'deu': 'Anime', 'ita':'Film biografici' } },
      { '@id': ns + 'MKKZ-BH2Q', 'skos:prefLabel': { 'eng': 'discussion', 'deu': 'Diskussion', 'ita':'Film di discussione' } },
      { '@id': ns + 'WVGH-KT47', 'skos:prefLabel': { 'eng': 'documentary film', 'deu': 'Diskussion', 'ita':'Documentario' } },
      { '@id': ns + 'XFDY-E13E', 'skos:prefLabel': { 'eng': 'drama', 'deu': 'Drama', 'ita':'Film drammatico' } },
      { '@id': ns + 'GZQE-YK3K', 'skos:prefLabel': { 'eng': 'fantasy film', 'deu': 'Fantasyfilm', 'ita':'Film fantasy' } },
      { '@id': ns + 'KM7A-FYPP', 'skos:prefLabel': { 'eng': 'television film', 'deu': 'Fernsehfilm', 'ita':'Film televisivo' } },
      { '@id': ns + 'MN1Y-YFCF', 'skos:prefLabel': { 'eng': 'historical film', 'deu': 'Historienfilm', 'ita':'Film storico' } },
      { '@id': ns + 'G2VQ-GEEK', 'skos:prefLabel': { 'eng': 'horror film', 'deu': 'Horrorfilm', 'ita':'Film dell\'orrore' } },
      { '@id': ns + 'GFM4-2J48', 'skos:prefLabel': { 'eng': 'comedy film', 'deu': 'Komödie', 'ita':'Commedia cinematografica' } },
      { '@id': ns + 'NQVM-6B2Y', 'skos:prefLabel': { 'eng': 'crime film', 'deu': 'Kriminalfilm', 'ita':'Film polizieschi' } },
      { '@id': ns + 'BPAJ-NQ8N', 'skos:prefLabel': { 'eng': 'short film', 'deu': 'Kurzfilm', 'ita':'Cortometraggio' } },
      { '@id': ns + 'AHWA-YKFH', 'skos:prefLabel': { 'eng': 'romance film', 'deu': 'Liebesfilm', 'ita':'Film sentimentale' } },
      { '@id': ns + '7RZF-5216', 'skos:prefLabel': { 'eng': 'music film', 'deu': 'Musikfilm', 'ita':'Film musicale' } },
      { '@id': ns + 'A1B4-K5MK', 'skos:prefLabel': { 'eng': 'newscast', 'deu': 'Nachrichtensendung', 'ita':'Programma di notizie' } },
      { '@id': ns + '8QDK-T11S', 'skos:prefLabel': { 'eng': 'opera', 'deu': 'Oper', 'ita':'Opere in musica' } },
      { '@id': ns + 'B4R8-Z419', 'skos:prefLabel': { 'eng': 'romance', 'deu': 'romance', 'ita':'Film mélo' } },
      { '@id': ns + 'XZ5S-JEJ5', 'skos:prefLabel': { 'eng': 'satire', 'deu': 'Satire', 'ita':'Film satirico', 'ita':'Film satirico' } },
      { '@id': ns + 'YV6T-SWAF', 'skos:prefLabel': { 'eng': 'science fiction film', 'deu': 'Science-Fiction-Film', 'ita':'Film fantascientifico' } },
      { '@id': ns + 'A8HT-N1QB', 'skos:prefLabel': { 'eng': 'television series', 'deu': 'Fernsehserie', 'ita':'Serie televisiva' } },
      { '@id': ns + '1VZT-KE1S', 'skos:prefLabel': { 'eng': 'thriller film', 'deu': 'Thriller', 'ita':'Thriller' } },
      { '@id': ns + 'PCK6-NYPG', 'skos:prefLabel': { 'eng': 'tragicomedy', 'deu': 'Tragikomödie', 'ita':'Tragicommedia' } },
      { '@id': ns + '2PV5-5V2H', 'skos:prefLabel': { 'eng': 'entertainment', 'deu': 'Unterhaltung', 'ita':'Programma di intrattenimento' } },
      { '@id': ns + 'G7EY-YXQR', 'skos:prefLabel': { 'eng': 'adventure film', 'deu': 'Abenteuerfilm', 'ita':'Film d\'avventura' } },
      { '@id': ns + 'W2SK-Q08A', 'skos:prefLabel': { 'eng': 'animation film', 'deu': 'Animationsfilm', 'ita':'Film d\'animazione' } },
      { '@id': ns + 'QHJ1-PVEB', 'skos:prefLabel': { 'eng': 'family film', 'deu': 'Familienfilm', 'ita':'Film per famiglie' } },
      { '@id': ns + 'D8B5-D0YT', 'skos:prefLabel': { 'eng': 'mystery film', 'deu': 'Mysteryfilm', 'ita':'Film del mistero' } },
      { '@id': ns + 'R8VJ-TMTB', 'skos:prefLabel': { 'eng': 'war film', 'deu': 'Kriegsfilm', 'ita':'Film di guerra'} },
      { '@id': ns + 'WZMQ-2NG6', 'skos:prefLabel': { 'eng': 'western', 'deu': 'Western', 'ita':'Film western' } }
    ],
    loaded: true
  },
  'moviegenre': {
    terms: [
      ...
      { '@id': ns + '8QDK-T11S', 'skos:prefLabel': { 'eng': 'opera', 'deu': 'Oper', 'ita':'Opere in musica' } },
      { '@id': ns + 'B4R8-Z419', 'skos:prefLabel': { 'eng': 'romance', 'deu': 'romance', 'ita':'Film mélo' } },
      { '@id': ns + 'XZ5S-JEJ5', 'skos:prefLabel': { 'eng': 'satire', 'deu': 'Satire', 'ita':'Film satirico' } },
      { '@id': ns + 'YV6T-SWAF', 'skos:prefLabel': { 'eng': 'science fiction film', 'deu': 'Science-Fiction-Film', 'ita':'Film fantascientifico' } },
      { '@id': ns + 'A8HT-N1QB', 'skos:prefLabel': { 'eng': 'television series', 'deu': 'Fernsehserie', 'ita':'Serie televisiva' } },,
      { '@id': ns + '1VZT-KE1S', 'skos:prefLabel': { 'eng': 'thriller film', 'deu': 'Thriller', 'ita':'Thriller' } },
      { '@id': ns + 'PCK6-NYPG', 'skos:prefLabel': { 'eng': 'tragicomedy', 'deu': 'Tragikomödie', 'ita':'Tragicommedia' } },
  ...
  'objecttypeuwm': {
    terms: [
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1552257', 'skos:prefLabel': { 'eng': 'Book', 'deu': 'Buch', 'ita': 'Libro' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1556244', 'skos:prefLabel': { 'eng': 'Patent', 'deu': 'Patent', 'ita': 'Brevetto' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1556237', 'skos:prefLabel': { 'eng': 'Conference Object', 'deu': 'Konferenzveröffentlichung', 'ita': 'Risultato di convegno' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1552259', 'skos:prefLabel': { 'eng': 'Multimedia', 'deu': 'Multimedia', 'ita': 'Multimedia' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1552260', 'skos:prefLabel': { 'eng': 'other', 'deu': 'sonstige', 'ita': 'altro' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1742', 'skos:prefLabel': { 'eng': 'Dissertation', 'deu': 'Dissertation', 'ita': 'Tesi di dottorato' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1552261', 'skos:prefLabel': { 'eng': 'Lecture series (one person)', 'deu': 'Vortragsserie (eine Person)', 'ita': 'Ciclo di conferenze (un relatore)' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1552253', 'skos:prefLabel': { 'eng': 'Article', 'deu': 'Artikel in Zeitschrift', 'ita': 'Articolo' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1743', 'skos:prefLabel': { 'eng': 'Professorial Dissertation', 'deu': 'Habilitationsschrift', 'ita': 'Dissertazione professorale' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1556239', 'skos:prefLabel': { 'eng': 'Working Paper', 'deu': 'Working Paper', 'ita': 'Working Paper' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1556236', 'skos:prefLabel': { 'eng': 'Review', 'deu': 'Rezension', 'ita': 'Recensione' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1556242', 'skos:prefLabel': { 'eng': 'Annotation', 'deu': 'Annotation', 'ita': 'Commento' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1557090', 'skos:prefLabel': { 'eng': 'Research Data', 'deu': 'Forschungsdaten', 'ita': 'Dati di ricerca' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1739', 'skos:prefLabel': { 'eng': 'Master\'s Dissertation', 'deu': 'Masterarbeit', 'ita': 'Tesi di laurea magistrale' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1556235', 'skos:prefLabel': { 'eng': 'Book Part', 'deu': 'Buchkapitel', 'ita': 'Capitolo di libro' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1740', 'skos:prefLabel': { 'eng': 'Diploma Dissertation', 'deu': 'Diplomarbeit', 'ita': 'Tesi di diploma' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1556240', 'skos:prefLabel': { 'eng': 'Preprint', 'deu': 'Preprint', 'ita': 'Articolo preliminare' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1552258', 'skos:prefLabel': { 'eng': 'Theses', 'deu': 'Hochschulschrift', 'ita': 'Tesi' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1741', 'skos:prefLabel': { 'eng': 'Master\'s (Austria) Dissertation', 'deu': 'Magisterarbeit', 'ita': 'Tesi di laurea magistrale (Austria)' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1738', 'skos:prefLabel': { 'eng': 'Baccalaureate Dissertation', 'deu': 'Bakkalaureatsarbeit', 'ita': 'Tesi di laurea triennale' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1552262', 'skos:prefLabel': { 'eng': 'Lecture', 'deu': 'Vortrag', 'ita': 'Lezione' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1556241', 'skos:prefLabel': { 'eng': 'Report', 'deu': 'Report', 'ita': 'Rapporto' } },
      { '@id': 'http://phaidra.univie.ac.at/XML/metadata/lom/V1.0/organization/voc_17/1552263', 'skos:prefLabel': { 'eng': 'Article in collected edition', 'deu': 'Beitrag im Sammelwerk', 'ita': 'Articolo in opera collettanea' } }
    ],
    loaded: true
  },
  'objecttype': {
    terms: [
      { '@id': ns + 'Z3K6-SWVD', 'skos:prefLabel': { 'eng': 'Bachelor theses', 'deu': 'Bachelorarbeit', 'ita': 'Tesi di laurea triennale' } },
      { '@id': ns + '9E94-E3F8', 'skos:prefLabel': { 'eng': 'Diplomarbeit', 'deu': 'Diplomarbeit', 'ita': 'Tesi di diploma' } },
      { '@id': ns + 'P2YP-BMND', 'skos:prefLabel': { 'eng': 'Master theses', 'deu': 'Masterarbeit', 'ita': 'Tesi di master' } },
      { '@id': ns + '1PHE-7VMS', 'skos:prefLabel': { 'eng': 'Dissertation', 'deu': 'Dissertation', 'ita': 'Tesi di dottorato' } },
      { '@id': ns + 'ST05-F6SP', 'skos:prefLabel': { 'eng': 'Magisterarbeit', 'deu': 'Magisterarbeit', 'ita': 'Tesi di laurea magistrale' } },
      { '@id': ns + '9ZSV-CVJH', 'skos:prefLabel': { 'eng': 'Habilitation', 'deu': 'Habilitation', 'ita': 'Abilitazione' } },
      { '@id': ns + 'H1TF-SDX1', 'skos:prefLabel': { 'eng': 'Master-Thesis (ULG)', 'deu': 'Master-Theses (ULG)', 'ita': 'Tesi di master (ULG)' } },
      ...
      { '@id': ns + '62RJ-SFV2', 'skos:prefLabel': { 'eng': 'cartographic material', 'deu': 'kartographisches Material', 'ita': 'Cartografia' } },
      ...
      { '@id': ns + 'W2Z3-3YA6', 'skos:prefLabel': { 'eng': 'data management plan', 'deu': 'Datenmanagementplan', 'ita': 'Piano di gestione dei dati' } },
      ...
      { '@id': ns + 'VKA6-9XTY', 'skos:prefLabel': { 'eng': 'journal article', 'deu': 'Wissenschaftlicher Artikel', 'ita': 'Articolo di rivista' } },
      ...
      { '@id': ns + 'M789-K5E0', 'skos:prefLabel': { 'eng': 'music album', 'deu': 'Musikalbum', 'ita': 'Album musicale' } },
      { '@id': ns + 'EWZ9-3MPH', 'skos:prefLabel': { 'eng': 'musical composition', 'deu': 'musikalische Komposition', 'ita': 'Composizione musicale' } },
      { '@id': ns + '8A6X-FKB1', 'skos:prefLabel': { 'eng': 'musical notation', 'deu': 'Musiknotation', 'ita': 'Notazione musicale' } },
      { '@id': ns + '9W35-5Q94', 'skos:prefLabel': { 'eng': 'negative', 'deu': 'Negativ', 'ita': 'Negativo' } },
      { '@id': ns + 'DCHD-W3GM', 'skos:prefLabel': { 'eng': 'newspaper', 'deu': 'Zeitung', 'ita': 'Giornale' } },
      { '@id': ns + 'CJJG-VKRQ', 'skos:prefLabel': { 'eng': 'newspaper article', 'deu': 'Zeitungsartikel', 'ita': 'Articolo di giornale' } },
      { '@id': ns + 'PYRE-RAWJ', 'skos:prefLabel': { 'eng': 'other', 'deu': 'sonstige', 'ita': 'Altro' } },
      { '@id': ns + '6QRG-9GN2', 'skos:prefLabel': { 'eng': 'other type of report', 'deu': 'Sonstiger Bericht', 'ita': 'Altro tipo di rapporto' } },
      ...
      { '@id': ns + 'Q4Q5-3554', 'skos:prefLabel': { 'eng': 'postcard', 'deu': 'Postkarte', 'ita': 'Cartolina' } },
      { '@id': ns + '6EFK-BRQD', 'skos:prefLabel': { 'eng': 'poster', 'deu': 'Plakat', 'ita': 'Manifesto' } },
      { '@id': ns + 'T023-BGTD', 'skos:prefLabel': { 'eng': 'preprint', 'deu': 'Preprint', 'ita': 'Articolo preliminare' } },
      { '@id': ns + '7WYH-AZ8C', 'skos:prefLabel': { 'eng': 'print', 'deu': 'druckgraphisches Blatt', 'ita': 'Stampa' } },
      { '@id': ns + 'T8PK-GADB', 'skos:prefLabel': { 'eng': 'project deliverable', 'deu': 'Projektergebnis', 'ita': 'Deliverable di progetto' } },
      { '@id': ns + 'MZ2Q-R099', 'skos:prefLabel': { 'eng': 'questionnaire', 'deu': 'Fragebogen', 'ita': 'Questionario' } },
      { '@id': ns + 'JMAV-7F3R', 'skos:prefLabel': { 'eng': 'report', 'deu': 'Bericht', 'ita': 'Rapporto' } },
      { '@id': ns + 'PHQ7-BGFA', 'skos:prefLabel': { 'eng': 'report part', 'deu': 'Teilbericht', 'ita': 'Rapporto ad interim' } },
      { '@id': ns + 'APV5-CJSF', 'skos:prefLabel': { 'eng': 'report to funding agency', 'deu': 'Bericht an Fördergeber', 'ita': 'Rapporto a un\'agenzia di finanziamento' } },
      { '@id': ns + '7J0J-HC61', 'skos:prefLabel': { 'eng': 'research report', 'deu': 'Forschungsbericht', 'ita': 'Rapporto di ricerca' } },
      { '@id': ns + 'VM3E-HXE6', 'skos:prefLabel': { 'eng': 'research software', 'deu': 'Forschungssoftware', 'ita': 'Software di ricerca' } },
      { '@id': ns + 'JJKV-B1CG', 'skos:prefLabel': { 'eng': 'review', 'deu': 'Rezension', 'ita': 'Recensione' } },
      { '@id': ns + 'XTVH-3MG3', 'skos:prefLabel': { 'eng': 'score', 'deu': 'Partitur', 'ita': 'Partitura' } },
      { '@id': ns + '21HZ-XP29', 'skos:prefLabel': { 'eng': 'sculpture', 'deu': 'Skulptur', 'ita': 'Scultura' } },
      { '@id': ns + '431H-5YSA', 'skos:prefLabel': { 'eng': 'slide', 'deu': 'Diapositiv', 'ita': 'Diapositiva' } },
      ...
      { '@id': ns + 'QTXN-YBJ3', 'skos:prefLabel': { 'eng': 'web application', 'deu': 'Web-Anwendung', 'ita': 'Applicazione web' } },
      { '@id': ns + 'T6C3-46S4', 'skos:prefLabel': { 'eng': '3D model', 'deu': '3D Model', 'ita': 'Modello 3D' } },
      { '@id': ns + '489N-Y6VX', 'skos:prefLabel': { 'eng': 'working paper', 'deu': 'Arbeitspapier', 'ita': 'Working paper' } },
      { '@id': ns + 'HARH-6R3C', 'skos:prefLabel': { 'eng': 'yearbook', 'deu': 'Jahrbuch', 'ita': 'Annuario' } },
      { '@id': ns + 'C36Q-N42M', 'skos:prefLabel': { 'eng': 'lantern slide', 'deu': 'Glasplattendia', 'ita': 'Lastra da lanterna magica' } }
    ],
    loaded: true
  },
  ...
  'uniakobjecttypetheses': {
    terms: [
      { '@id': 'http://base.uni-ak.ac.at/vocabulary/diploma', 'skos:prefLabel': { 'eng': 'Diploma', 'deu': 'Diplomarbeit', 'ita': 'Diploma' } },
      { '@id': 'http://base.uni-ak.ac.at/vocabulary/master', 'skos:prefLabel': { 'eng': 'Master thesis', 'deu': 'Masterarbeit', 'ita': 'Tesi di master' } },
      { '@id': 'http://base.uni-ak.ac.at/vocabulary/bachelor', 'skos:prefLabel': { 'eng': 'Bachelor thesis', 'deu': 'Bachelorarbeit', 'ita': 'Tesi di laurea' } },
      { '@id': 'http://base.uni-ak.ac.at/vocabulary/doctoral_programmes', 'skos:prefLabel': { 'eng': 'Dissertation', 'deu': 'Dissertation', 'ita': 'Tesi di dottorato' } },
      { '@id': 'http://base.uni-ak.ac.at/vocabulary/written_component_of_artistic_thesis', 'skos:prefLabel': { 'eng': 'Written component of artistic Thesis', 'deu': 'Schriftlicher Teil der künstlerischen Abschlussarbeit', 'ita': 'Parte scritta della tesi artistica' } }
    ],
    loaded: true
  },
  'oerobjecttype': {
    terms: [
      { '@id': 'https://w3id.org/kim/hcrt/application', 'skos:prefLabel': { 'eng': 'Software Application', 'deu': 'Softwareanwendung', 'ita': 'Applicazione software' } },
      { '@id': 'https://w3id.org/kim/hcrt/assessment', 'skos:prefLabel': { 'eng': 'Assessment', 'deu': 'Lernkontrolle', 'ita': 'Valutazione' } },
      { '@id': 'https://w3id.org/kim/hcrt/audio', 'skos:prefLabel': { 'eng': 'Audio Recording', 'deu': 'Audio', 'ita': 'Fonoregistrazione' } },
      { '@id': 'https://w3id.org/kim/hcrt/case_study', 'skos:prefLabel': { 'eng': 'Case Study', 'deu': 'Fallstudie', 'ita': 'Caso di studio' } },
      { '@id': 'https://w3id.org/kim/hcrt/course', 'skos:prefLabel': { 'eng': 'Course', 'deu': 'Kurs', 'ita': 'Corso' } },
      { '@id': 'https://w3id.org/kim/hcrt/data', 'skos:prefLabel': { 'eng': 'Data', 'deu': 'Daten', 'ita': 'Dati' } },
      { '@id': 'https://w3id.org/kim/hcrt/diagram', 'skos:prefLabel': { 'eng': 'Diagram', 'deu': 'Grafik', 'ita': 'Diagramma' } },
      { '@id': 'https://w3id.org/kim/hcrt/drill_and_practice', 'skos:prefLabel': { 'eng': 'Drill and Practice', 'deu': 'Übung', 'ita': 'Esercitazione' } },
      { '@id': 'https://w3id.org/kim/hcrt/educational_game', 'skos:prefLabel': { 'eng': 'Game', 'deu': 'Lernspiel', 'ita': 'Gioco educativo' } },
      { '@id': 'https://w3id.org/kim/hcrt/experiment', 'skos:prefLabel': { 'eng': 'Experiment', 'deu': 'Experiment', 'ita': 'Esperimento' } },
      { '@id': 'https://w3id.org/kim/hcrt/image', 'skos:prefLabel': { 'eng': 'Image', 'deu': 'Abbildung', 'ita': 'Illustrazione' } },
      { '@id': 'https://w3id.org/kim/hcrt/index', 'skos:prefLabel': { 'eng': 'Reference Work', 'deu': 'Nachschlagewerk', 'ita': 'Opera di consultazione' } },
      { '@id': 'https://w3id.org/kim/hcrt/lesson_plan', 'skos:prefLabel': { 'eng': 'Lesson Plan', 'deu': 'Unterrichtsplanung', 'ita': 'Piano di lezione' } },
      { '@id': 'https://w3id.org/kim/hcrt/map', 'skos:prefLabel': { 'eng': 'Map', 'deu': 'Karte', 'ita': 'Mappa' } },
      { '@id': 'https://w3id.org/kim/hcrt/portal', 'skos:prefLabel': { 'eng': 'Web Portal', 'deu': 'Portal', 'ita': 'Portale web' } },
      { '@id': 'https://w3id.org/kim/hcrt/questionnaire', 'skos:prefLabel': { 'eng': 'Questionnaire', 'deu': 'Fragebogen', 'ita': 'Questionario' } },
      { '@id': 'https://w3id.org/kim/hcrt/script', 'skos:prefLabel': { 'eng': 'Script', 'deu': 'Skript', 'ita': 'Copione' } },
      { '@id': 'https://w3id.org/kim/hcrt/sheet_music', 'skos:prefLabel': { 'eng': 'Sheet Music', 'deu': 'Musiknoten', 'ita': 'Partitura' } },
      { '@id': 'https://w3id.org/kim/hcrt/simulation', 'skos:prefLabel': { 'eng': 'Simulation', 'deu': 'Simulation', 'ita': 'Simulazione' } },
      { '@id': 'https://w3id.org/kim/hcrt/slide', 'skos:prefLabel': { 'eng': 'Presentation', 'deu': 'Präsentation', 'ita': 'Presentazione' } },
      { '@id': 'https://w3id.org/kim/hcrt/text', 'skos:prefLabel': { 'eng': 'Text', 'deu': 'Textdokument', 'ita': 'Testo' } },
      { '@id': 'https://w3id.org/kim/hcrt/textbook', 'skos:prefLabel': { 'eng': 'Textbook', 'deu': 'Lehrbuch', 'ita': 'Testo scolastico' } },
      { '@id': 'https://w3id.org/kim/hcrt/video', 'skos:prefLabel': { 'eng': 'Video', 'deu': 'Video', 'ita': 'Video' } },
      { '@id': 'https://w3id.org/kim/hcrt/web_page', 'skos:prefLabel': { 'eng': 'Web Page', 'deu': 'Webseite', 'ita': 'Sito web' } },
      { '@id': 'https://w3id.org/kim/hcrt/worksheet', 'skos:prefLabel': { 'eng': 'Worksheet', 'deu': 'Arbeitsmaterial', 'ita': 'Materiale di lavoro' } },
      { '@id': 'https://w3id.org/kim/hcrt/other', 'skos:prefLabel': { 'eng': 'Other', 'deu': 'Sonstiges', 'ita': 'Altro' } },
    ],
    loaded: true
  },
  'accessright': {
    terms: [
      { '@id': ns + 'QW5R-NG4J', 'skos:prefLabel': { 'eng': 'open access' }, 'skos:definition': { 'eng': 'Open access refers to a resource that is immediately and permanently online, and free for all on the Web, without financial and technical barriers.The resource is either stored in the repository or referenced to an external journal or trustworthy archive.', 'ita': 'L\'accesso aperto si riferisce a una risorsa che è immediatamente e permanentemente disponibile online, e gratuitamente per tutti sul Web, senza barriere finanziarie e tecniche. La risorsa è archiviata nel repository o è collegata a una rivista esterna o a un archivio affidabile.' } },
      { '@id': ns + 'AVFC-ZZSZ', 'skos:prefLabel': { 'eng': 'embargoed access' }, 'skos:definition': { 'eng': 'Embargoed access refers to a resource that is metadata only access until released for open access on a certain date. Embargoes can be required by publishers and funders policies, or set by the author (e.g such as in the case of theses and dissertations).', 'ita': 'Accesso in embargo si riferisce a una risorsa per la quale è consentito l\'accesso solo ai metadati fino alla sua pubblicazione in Open Access in una data specifica. Gli embargo possono essere richiesti dalle politiche degli editori e dei finanziatori, o essere impostati dall\'autore (ad esempio, nel caso di tesi e dissertazioni).' } },
      { '@id': ns + 'KC3K-CCGM', 'skos:prefLabel': { 'eng': 'restricted access' }, 'skos:definition': { 'eng': 'Restricted access refers to a resource that is available in a system but with some type of restriction for full open access. This type of access can occur in a number of different situations. Some examples are described below: The user must log-in to the system in order to access the resource The user must send an email to the author or system administrator to access the resource Access to the resource is restricted to a specific community (e.g. limited to a university community).', 'ita': 'L\'accesso ristretto si riferisce a una risorsa disponibile in un sistema ma con alcune restrizioni per l\'accesso completo in Open Access. Questo tipo di accesso può verificarsi in diverse situazioni. Alcuni esempi sono descritti di seguito: l\'utente effettuare il login nel sistema per accedere alla risorsa; l\'utente deve inviare un\'email all\'autore o all\'amministratore del sistema per accedere alla risorsa; l\'accesso alla risorsa è limitato a una comunità specifica (ad esempio è limitato a una comunità universitaria).' } },
      { '@id': ns + 'QNGE-V02H', 'skos:prefLabel': { 'eng': 'metadata only access' }, 'skos:definition': { 'eng': 'Metadata only access refers to a resource in which access is limited to metadata only. The resource itself is described by the metadata, but neither is directly available through the system or platform nor can be referenced to an open access copy in an external journal or trustworthy archive.', 'ita': 'L\'accesso limitato ai metadati si riferisce a una risorsa per la quale l\'accesso è limitato esclusivamente ai metadati. La risorsa stessa è descritta dai metadati, ma non è direttamente disponibile attraverso il sistema o la piattaforma, né è possibile fare riferimento a una copia ad accesso aperto in una rivista esterna o in un archivio affidabile.' } }
    ],
    loaded: true
  },
  'iraccessright': {
    terms: [
      { '@id': ns + 'QW5R-NG4J', 'skos:prefLabel': { 'eng': 'open access' }, 'skos:definition': { 'deu': 'Der Zugriff auf die Ressource wird ohne Einschränkungen angeboten.', 'eng': 'Access to the resource is offered without any restrictions.', 'ita': 'L\'accesso alla risorsa è offerto senza alcuna restrizione.' } },
  ...
  'technique': {
    terms: [
      { '@id': ns + 'NZ42-TTZT', 'skos:prefLabel': { 'eng': 'black-and-white photography', 'deu': 'Schwarz-Weiß-Fotografie', 'ita': 'Fotografia in bianco e nero' } },
      { '@id': ns + 'DC1W-JWNP', 'skos:prefLabel': { 'eng': 'color photography', 'deu': 'Farb-Fotografie', 'ita': 'Fotografia a colori' } },
      { '@id': ns + '431H-5YSA', 'skos:prefLabel': { 'eng': 'slide', 'deu': 'Diapositiv', 'ita': 'Diapositiva' } },
      { '@id': ns + 'VZ88-24TF', 'skos:prefLabel': { 'eng': 'black-and-white slide', 'deu': 'Schwarz-Weiß-Dia', 'ita': 'Diapositiva in bianco e nero' } },
      { '@id': ns + '96PV-FFAT', 'skos:prefLabel': { 'eng': 'color slide', 'deu': 'Farb-Dia', 'ita': 'Diapositiva a colori' } },
      { '@id': ns + 'AH0S-F3BV', 'skos:prefLabel': { 'eng': 'black-and-white film', 'deu': 'Schwarz-Weiß-Film', 'ita': 'Cinema in bianco e nero' } },
      { '@id': ns + 'K818-FSM5', 'skos:prefLabel': { 'eng': 'color film', 'deu': 'Farb-Film', 'ita': 'Cinema a colori' } },
      { '@id': ns + '748F-SQW9', 'skos:prefLabel': { 'eng': 'silent film', 'deu': 'Stummfilm', 'ita': 'Cinema muto' } },
      { '@id': ns + '1K09-VXQ4', 'skos:prefLabel': { 'eng': 'sound film', 'deu': 'Tonfilm', 'ita': 'Cinema sonoro' } }
    ],
    loaded: true
  },
  'material': {
  ...
  'reproduction': {
    terms: [
      { '@id': ns + 'AYRE-RQAS', 'skos:prefLabel': { 'eng': 'original', 'deu': 'Original', 'ita': 'Originale' } },
      { '@id': ns + 'BD33-7WA2', 'skos:prefLabel': { 'eng': 'copy', 'deu': 'Kopie', 'ita': 'Copia' } }
    ],
    loaded: true
  },
  'audience': {
